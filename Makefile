...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="read_record" -DDUCKDB_OOT_EXTENSION_READ_RECORD_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_READ_RECORD_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_READ_RECORD_INCLUDE_PATH="$(PROJ_DIR)src/include"
